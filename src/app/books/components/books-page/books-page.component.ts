...
import { bookCreated } from "../../actions/books-api.actions";
@Component({
  selector: "app-books",
...
export class BooksPageComponent implements OnInit {
  ...
  updateBook(book: BookModel) {
    ...
    this.booksService.update(book.id, book).subscribe((book) => {
      this.store.dispatch(BooksApiActions.booksUpdated({ book }));
  ...
  onDelete(book: BookModel) {
    ...
    this.booksService.delete(book.id).subscribe((bookId) => {
